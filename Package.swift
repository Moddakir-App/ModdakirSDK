...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "ModdakirSDK",
            url: "https://github.com/Moddakir-App/ModdakirSDK/releases/download/0.0.16/ModdakirSDK.xcframework.zip",
            checksum: "a2f60a9ca2ee09313520781b6a845908dfefe865e2bb27d4ad09069405bfad60"
        )
    ]
)
